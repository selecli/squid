...
MOD_STREAMING_DLL_LOCAL extern
unsigned int stbl_get_nearest_keyframe_prev(stbl_t const* stbl, unsigned int sample, unsigned int *next_keyframe);
MOD_STREAMING_DLL_LOCAL extern
unsigned int stbl_get_nearest_keyframe_next(stbl_t const* stbl, unsigned int sample);
...
MOD_STREAMING_DLL_LOCAL extern
unsigned int stss_get_nearest_keyframe_prev(stss_t const* stss, unsigned int sample, unsigned int *next_keyframe);
MOD_STREAMING_DLL_LOCAL extern
unsigned int stss_get_nearest_keyframe_next(stss_t const* stss, unsigned int sample);
...
MOD_STREAMING_DLL_LOCAL extern
mp4_context_t* mp4_open(const char* filename, int64_t filesize,mp4_open_flags flags, int verbose,int64_t filesize_offset);
