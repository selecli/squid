...
storeAppendPrintf(sentry, "\tStorage Swap size:\t%" PRINTF_OFF_T " KB\n",
		store_swap_size);
...
storeAppendPrintf(sentry,"hash conflicts : %d\n",hash_conflict);
storeAppendPrintf(sentry,"cached results : %d\n",cached_result);
storeAppendPrintf(sentry,"acl cache hits : %d\n",acl_cache_hit);
#endif
}
