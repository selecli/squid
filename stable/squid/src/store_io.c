...
#ifdef CC_FRAMEWORK
void
storeZCopy(storeIOState * sio, int targetfd, size_t size, squid_off_t offset, STRCB * callback, void *callback_data)
{
	SwapDir *SD = &Config.cacheSwap.swapDirs[sio->swap_dirn];
	(SD->obj.zcopy) (SD, sio, targetfd, size, offset, callback, callback_data);
}
#endif
void
