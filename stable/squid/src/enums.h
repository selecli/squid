...
typedef enum {
    ...
    TCP_RESET,
    ERR_INVALID_RESP,
	ERR_HTTP_SPECIAL,       /* special error added by jiangbo.tian for customized_server_side_error_page*/
#ifdef CC_FRAMEWORK
...
typedef enum {
	...
	NCR_PRAGMA_NO_CACHE,
	NCR_X_MIXED_REPLACE,
	NCR_REFRESH_IS_CACHABLE,
	NCR_NO_DLPE,
	NCR_302_NO_EXPIRES,
	NCR_HTTP_CODE,
	NCR_NOT_METHOD_CACHABLE,
	NCR_BAD_LENGTH,
	NCR_RELEASE_REQUEST,
	NCR_NOT_ENTRY_CACHABLE,
	NCR_NEG_CACHED,
	NCR_TOO_BIG,
	NCR_TOO_SMALL,
	NCR_KEY_PRIVATE,
	NCR_TOO_MANY_DISK_FILES_OPEN,
	NCR_TOO_MANY_FD_OPEN,
	NCR_SERVER_CLOSE,
	NCR_CLIENT_ABORT,
	NCR_FWD_FAIL,
	NCR_DISK,
...
typedef enum{
	...
	REDIRECT_TO_RELOAD = 0,
	REDIRECT_RELOADING = 1,
	REDIRECT_RELOAD_DONE = 2,
	REDIRECT_TO_RELOAD_FULLLOAD = 3
