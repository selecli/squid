...
#ifdef CC_FRAMEWORK
typedef struct _CossRemoveState CossRemoveState;
#endif
...
void aioWrite(int, off_t offset, char *, int size, AIOCB *, void *, FREE *, int index);
void aioRead(int, off_t offset, int size, AIOCB *, void *, int index);
#else
...
#ifdef CC_FRAMEWORK
    off_t mark; /* This is a mark to mark a end*/
    int rmark;
#endif
    int fd;
    int swaplog_fd;
...
#ifdef CC_FRAMEWORK
extern void storeCossStartMembuf2(SwapDir * SD);
#endif
