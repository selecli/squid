...
#define parseConfigFile_h

#define CONFIGEFILE "/usr/local/squid/etc/cpisDns.conf"

#define CIDRLIST 	"cidrlist"
#define PBLIPLIST 	"pbliplist"
...
/* member of name for the config list */
typedef struct list_mem{
	MEM_VALUE *cidrlist;		/* the cidrlist */
	MEM_VALUE *pbliblist;		/* the value list */
	MEM_VALUE *cur_pbliblist;
}LIST_MEM;
