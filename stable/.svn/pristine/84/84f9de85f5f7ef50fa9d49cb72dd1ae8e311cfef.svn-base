...
#ifdef CC_FRAMEWORK
/* added by cc */
/*extern cc_module *cc_modules;  NULL */
extern sigset_t not_parse_config; 
extern Array cc_modules; /* { 0, 0, NULL } */
extern Array cc_modules_r; /* { 0, 0, NULL } */
extern dlink_list unfree_fd_param; /* {NULL, NULL} */
extern Array cc_effective_modules; /* { 0, 0, NULL } */
extern Array cc_hook_to_module[HPIDX_last]; /* {} */
extern Array cc_hook_to_module_r[HPIDX_last];
extern unsigned int hash_conflict;
extern unsigned int cached_result;
extern unsigned int acl_cache_hit;
extern const char *NOCACHE_REASON_STR[];
extern MemPool * cc_mod_param_pool; /* NULL */
extern MemPool * cc_run_state_pool;  /* NULL */
extern MemPool * matched_mod_params_pool;  /* NULL */
extern MemPool * cc_private_data_pool;  /* NULL */
extern int http_port_cfg_changed; /* 0 */
extern int listen_80_fd; /* -1 */
#endif
#ifdef CC_MULTI_CORE
extern int opt_total_squids; /* 1 */
extern int opt_squid_id; /* -1 */
#endif
extern FILE *debug_log;		/* NULL */
extern SquidConfig Config;
extern SquidConfig2 Config2;
extern SquidConfig Config_r;
extern int reconfigure_in_thread;
extern char *ConfigFile;	/* NULL */
extern int parse_over;
extern int do_reconfigure; // the meaning is reconfigure_done
...
#ifdef CC_FRAMEWORK
/*for config file optimization*/
extern rms_t RequestMethods_r[];
#endif
extern const char *ProtocolStr[];
extern const char *cfg_filename;	/* NULL */
extern const char *const appname;	/* "FC" */
extern const char *const dash_str;	/* "-" */
extern const char *const localhost;	/* "127.0.0.1" */
extern const char *const null_string;	/* "" */
extern const char *const version_string;    /* "7.0.R.16488.i686" */
extern const char *const full_appname_string;   /* "FC" "/" "7.0.R.16488.i686" */
extern const char *const appname_string;	/* "FC" */
...
#ifdef CC_FRAMEWORK
extern int opt_forwarded_for_r;	/* 1 */
#endif
...
#ifdef CC_FRAMEWORK
extern squid_off_t store_swap_size;	/* 0 */
#else
...
extern unsigned long long comm_select_serial;	/* 0 */
#ifdef _SQUID_WIN32_
...
extern int cc_fc_reload_check;  /* 0 */
