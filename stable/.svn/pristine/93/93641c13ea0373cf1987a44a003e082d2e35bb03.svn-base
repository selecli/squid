...
struct _SquidConfig {
    ...
    int appendDomainLen;
#ifdef CC_FRAMEWORK	
    int debugLogTsSwitch; /*log timestamp in msecond. 0: in second only, 1: in msecond*/
    int evenRunMaxMsec;/*eventRun last for max msec. ignore time if set 0, otherwise, break if running time is more than the setting*/
    int b4RecfgWaitMsec;            /* default 300 ms */
    int b4DefaultLoadModuleWaitMsec;/* default 300 ms*/
    int b4DefaultIfNoneRWaitMsec;   /* default 300 ms*/
    int b4ParseOnePartCfgWaitMsec;  /* default 100 ms*/
    int b4AccessCleanWaitMsec;      /* default 20  ms*/
    int b4AccessCombineWaitMsec;    /* default 100 ms*/
    int b4AccessFreeWaitMsec;       /* default 10  ms*/
#endif    
    char *debugOptions;
    char *pidFilename;
    char *netdbFilename;
...
#ifdef CC_FRAMEWORK	
    int debug_80_log; /*true: switch on debug log for 80, off: switch off debug log for 80*/
#endif  	
    } onoff;
    acl *aclList;
#ifdef CC_FRAMEWORK
	access_array *accessList2[SQUID_CONFIG_ACL_BUCKET_NUM];
	char* current_domain;
	char cc_mod_dir[MAX_PATH_LEN];
	int cc_all_mod_num;
#endif
    struct {
	acl_access *http;
...
#endif
#ifdef CC_FRAMEWORK
	short int * cc_run_state;
	Array * matched_mod_params;
	cc_private_data *cc_fde_private_data;
	int cctype; //zds add at 2009-11-18 for distinct the client or server fd : 0 == client 1 == server
#endif
};
...
struct _HttpHeaderHashField {
	http_hdr_type id;
	HttpHeaderHashField* next;
};
...
struct _HttpHeaderEntry {
    ...
    String name;
    String value;
	int nRepeat;		//zhb: mask this header is repeat
};

struct _HttpHeader {
    /* protected, do not use these, use interface functions instead */
    Array entries;		/* parsed entries in raw format */
	//zhb:entries for search
	int pSearch[128];
	int nEndSearch;
...
struct _clientHttpRequest {
    ...
    int is_modified;
#ifdef CC_FRAMEWORK
	cc_private_data *cc_clientHttpRequest_private_data;
//	char* meta_url;
#endif
...
#ifdef CC_FRAMEWORK
	cc_private_data *cc_connStateData_private_data;
#endif
};
...
#ifdef CC_FRAMEWORK
    cc_private_data *cc_MemObject_private_data;
#endif
...
#ifdef CC_FRAMEWORK
    sfileno mem_swap_filen;
    double when;
	cc_private_data *cc_StoreEntry_private_data;
#endif
};
...
#ifdef CC_FRAMEWORK
    int cur_obj_cnt;
    int snapshot;  /* This tell the limit*/
#endif
    int cur_size;
    int low_size;
    int max_size;
...
#ifdef CC_FRAMEWORK
    STLIMITOBJ *limitobj;   /*Check if total obj is out of limit, then deal with it*/
#endif
...
#ifdef CC_FRAMEWORK
	cc_private_data *cc_request_private_data;
	int cc_acl_matches;
	int cc_acl_adds;
	int cc_acl_deletes;
#endif
...
#ifdef CC_FRAMEWORK
    fde old_fd_params;
    cc_private_data *cc_fwdState_private_data;
	int called;
	void *data;
#endif
...
#ifdef CC_FRAMEWORK
	unsigned int reload_stats:2;			//add by fangfang.yang for redirect_load function 
#endif
    } flags;
    struct {
	int uses;
