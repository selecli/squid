...
typedef struct _HttpHeaderHashField HttpHeaderHashField;
...
#ifdef CC_FRAMEWORK
typedef struct _queued_zcopy queued_zcopy;
#endif
...
#ifdef CC_FRAMEWORK
typedef struct _LruPolicyNode LruPolicyNode;
#endif
...
typedef void DRCB(int, const char *buf, int size, int errflag, void *data);
							/* Disk read CB */
typedef void DZCCB(int, int, int size, int errflag, void *data);
...
#ifdef CC_FRAMEWORK
typedef void STZCCB(void *, ssize_t);	/* store callback */
#endif
...
#ifdef CC_FRAMEWORK
typedef void STLIMITOBJ(SwapDir *);
#endif
...
#ifdef CC_FRAMEWORK
typedef void STOBJZCOPY(SwapDir *, storeIOState *, int, size_t, squid_off_t, STRCB *, void *);
#endif
...
#ifdef CC_FRAMEWORK
typedef struct _access_array access_array;
#endif
